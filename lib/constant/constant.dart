...
TextStyle login = const TextStyle(fontSize: 20, fontWeight: FontWeight.w700);
TextStyle subTitle = const TextStyle(fontSize: 14, fontWeight: FontWeight.w500);
TextStyle buttonLogin =
